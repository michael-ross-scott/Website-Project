<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Canabiz.Admin.AdminPage" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server"
                    ItemType="Canabiz.Models.Product"
