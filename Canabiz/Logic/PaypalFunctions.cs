...
public class NVPAPICaller
{
    ...
    public string APIUsername = "michael.ross.scott_api1.gmail.com";
    private string APIPassword = "K86REBNGQXS6SCW6";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A-ysCudizESArVghcSOD0SKCPRc6";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:59207/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:59207/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Cannoisseurs";
        encoder["PAYMENTREQUEST_0_AMT"] = amt;
        encoder["PAYMENTREQUEST_0_ITEMAMT"] = amt;
        encoder["PAYMENTREQUEST_0_PAYMENTACTION"] = "Sale";
        encoder["PAYMENTREQUEST_0_CURRENCYCODE"] = "USD";//there is no such thing as rands on the paypal website

        // Get the Shopping Cart Products
        using (Canabiz.Logic.ShoppingCartActions myCartOrders = new Canabiz.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            //Canabiz.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
