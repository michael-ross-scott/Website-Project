<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Canabiz.ShoppingCart" %>
...
Cart</h1>
    ...
    <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="False"
        ...
        ItemType="Canabiz.Models.CartItem"
