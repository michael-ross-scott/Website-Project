<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckoutReview.aspx.cs" Inherits="Canabiz.Checkout.CheckoutReview" %>
...
(each)"
    ...
    <asp:DetailsView ID="ShipInfo" runat="server" AutoGenerateRows="false"
        GridLines="None" CellPadding="10" BorderStyle="None" CommandRowStyleBorderStyle="None">
        <Fields>
            <asp:TemplateField>
                <ItemTemplate>
